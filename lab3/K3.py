...
if sumA > sumB and sumA > sumC:
    print("Переможцем за методом Борда є кандидат А з рахунком", sumA, "очків")
elif sumB > sumA and sumB > sumC:
    print("Переможцем за методом Борда є кандидат Б з рахунком", sumB, "очків")
elif sumC > sumA and sumC > sumB:
    print("Переможцем за методом Борда є кандидат C з рахунком", sumC, "очків")
else:
...
if ab > ba and ac > ca:
    print("Переможцем за методом Кондорсе є кандидат А")
elif bc > cb and ba > ab:
    print("Переможцем за методом Кондорсе є кандидат Б")
elif ca > ac and cb > bc:
    print("Переможцем за методом Кондорсе є кандидат С")
else:
    print("Переможця за методом Кондорсе не знайдено.")
